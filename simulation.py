...
def run_simulation():
    ...
    loader_queue.insert(truck_list[0])
    loader_queue.insert(truck_list[1])
    loader_queue.insert(truck_list[2])
    loader_queue.insert(truck_list[3])
    loader_queue.insert(truck_list[4])
